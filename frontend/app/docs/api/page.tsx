...
export default async function PaginationPage() {
  ...
  const docsPath = path.join(process.cwd(), 'docs', 'backendCalls.md');
    ...
    return (
      <div className="prose max-w-none">
        ...
        <p className="text-red-600">
          Could not load the api documentation. Please make sure the file exists at: <code>docs/backendCalls.md</code>
        </p>
